...
class ImageComposition():
    ...
    def __init__(self):
        ...
        self.max_foregrounds = 45
        self.mask_colors = [(255, 0, 0), (0, 255, 0), (0, 0, 255), (255, 255, 0), (255, 0, 255),
                            (0, 255, 255), (100, 100, 100), (255, 100, 100), (255, 100, 0), (0, 100, 0),
                            (0, 0, 100), (100, 0, 0), (50, 50, 255), (50, 255, 50), (255, 50, 50), 
                            (150, 150, 150), (0, 0, 150), (0, 150, 0), (150, 0, 0), (150, 0, 150), 
                            (0, 150, 150), (150, 150, 0), (200, 200, 200), (200, 200, 0), (200, 0, 200),
                            (0, 200, 200), (50, 50, 50), (50, 50, 0), (50, 0, 50), (0, 50, 50),
                            (200, 0, 0), (0, 200, 0), (0, 0, 200), (100, 100, 0), (100, 0, 100), 
                            (0, 100, 100), (80, 80, 80), (80, 0, 80), (0, 80, 80), (80, 80, 0),
                            (80, 0, 0),(0, 0, 80), (0, 80, 0), (170, 80, 80), (255, 170, 100),
                            (255, 170, 0), (0, 170, 100), (0, 170, 0), (170, 170, 170), (120, 120, 120), 
                            (120, 120, 255), (120, 255, 120)]
        #self.foregrounds_dir = []
    ...
    def _generate_images(self):
        ...
        for i in tqdm(range(self.count)):
            ...
            num_foregrounds = random.randint(self.max_foregrounds, self.max_foregrounds)
            foregrounds = []
...
if __name__ == "__main__":
    ...
    #parser.add_argument("--foregrounds_dir", type=str, dest="foregrounds_dir")
